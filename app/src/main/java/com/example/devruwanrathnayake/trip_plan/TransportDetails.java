...
public class TransportDetails extends AppCompatActivity {
    ...
    form form;
    EditText NIC1, NIC, customerName, email, tp, passenger, type, in, out;
    Button btnSave;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewdetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatabaseReference readRef = FirebaseDatabase.getInstance().getReference().child("Transport").child(NIC1.getText().toString().trim());
                readRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(TextUtils.isEmpty(NIC1.getText().toString())){
                            ...
                            passenger.setText(dataSnapshot.child("rooms").getValue().toString());
        ...
        updatedetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseReference Upref = FirebaseDatabase.getInstance().getReference().child("Transport");
                Upref.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild(NIC1.getText().toString().trim())){
                            ...
                            databaseReference = FirebaseDatabase.getInstance().getReference().child("Transport").child(NIC.getText().toString().trim());
        ...
        deletedetails.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseReference delRef = FirebaseDatabase.getInstance().getReference().child("Transport");
